...
cat("\n* Pente R (Radius 1) : **", round(res$slope_r, 4), "**")

cat("\n* Pente R (Radius 2) : **", round(res2$slope_r, 4), "**")

cat("\n* Pente Rcpp (Radius 1) : **", round(res$slope_rcpp, 4), "**")

cat("\n* Pente Rcpp (Radius 2) : **", round(res2$slope_rcpp, 4), "**")

```
On voit conformément aux résultats théorique attendu que la complexité varie peu selon le radius.
